...
In designing the treat model we take into consideration that Cucumber and its
components are a test-tool intended to be used with and within trusted code. 

As such the treat model focuses almost entirely on artifact security.
...
RubyGems, ect, ect. Users that consume artifacts in this fashion, should obtain
